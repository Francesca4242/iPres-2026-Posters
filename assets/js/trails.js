/* ==========================================================================
   Themed trails - guided walks through the poster hall.
...
const TRAILS = [
  {
    ...
    emoji: '\u{1F501}',
    color: '#0b82c6',
    blurb: 'Pipelines, packagers and process diagrams. Start here if you are looking for a workflow to take home.',
    keywords: ['workflow'],
  ...
  },
  {
    ...
    emoji: '\u{1F5C4}️',
    color: '#0769a3',
    blurb: 'The machinery underneath everything: storage media, containers, autoscaling and bit-level care.',
  ...
  },
  {
    ...
    emoji: '\u{1F342}',
    color: '#eab308',
    blurb: 'Appraisal, triage, retention and deletion. Nobody can keep everything, and these posters address that directly.',
    themes: ['ingest'],
  ...
  },
  {
    ...
    emoji: '\u{1F50D}',
    color: '#06b6d4',
    blurb: 'Getting material back out again: discovery, delivery, emulation, captions and the reading room of the future.',
    themes: ['access'],
  },
  {
    id: 'metadata',
    ...
    emoji: '\u{1F3F7}️',
    color: '#10b981',
    blurb: 'Schemas, standards, provenance and the lasting value of good description.',
    themes: ['metadata'],
  },
  {
    id: 'people',
    ...
    emoji: '\u{1F91D}',
    color: '#ef4444',
    blurb: 'Networks, national initiatives, training and advocacy. Preservation is collaborative work.',
    themes: ['community'],
  ...
  },
  {
    ...
    emoji: '\u{1F4CA}',
    color: '#f97316',
    blurb: 'Maturity models, surveys, audits and costs. For anyone who has to justify a budget.',
    themes: ['management'],
  ...
  },
  {
    ...
    emoji: '⚖️',
    color: '#d946ef',
    blurb: 'Law, ethics, sensitive material and the environmental cost of keeping everything indefinitely.',
    themes: ['policy'],
  ...
  },
  {
    ...
    emoji: '\u{1F9EC}',
    color: '#8b5cf6',
    blurb: 'Fixity, characterisation, migration and the long tail of difficult file formats.',
    themes: ['formats'],
  ...
  },
  {
    ...
    emoji: '\u{1F916}',
    color: '#111827',
    blurb: 'Where automation, speech recognition and AI are appearing in preservation practice.',
  ...
  },
  {
    ...
    emoji: '\u{1F30D}',
    color: '#0ea5e9',
    blurb: 'Posters from outside Europe, from Vancouver to Beijing to Rio and back.',
  ...
  },
  {
    ...
    emoji: '☕',
    color: '#b45309',
    blurb: 'Fifteen minutes to spare? One poster from each theme, in the order you will walk past them.',
...
const QUIZ = [
  {
    ...
    options: [
      ...
      { label: 'I have to make the case to management', weights: { money: 3, ethics: 2, people: 2 } },
      { label: 'I am here for the people', weights: { people: 3, worldwide: 2, quick: 1 } },
    ],
  },
  {
    id: 'itch',
    question: 'Which problem is most pressing for you?',
    options: [
      { label: 'Our workflow needs rebuilding', weights: { workflows: 3, formats: 1 } },
      { label: 'We are keeping more than we need', weights: { 'letting-go': 3, money: 1 } },
      { label: 'Nobody can find anything', weights: { access: 3, metadata: 2 } },
      { label: 'Everyone is asking about AI', weights: { robots: 3, ethics: 1 } },
    ],
  },
  {
    id: 'time',
    ...
    options: [
      { label: 'Fifteen minutes', weights: { quick: 4 } },
      { label: 'A coffee break', weights: { workflows: 1, access: 1, metadata: 1 } },
      { label: 'The whole hall', weights: { infrastructure: 1, people: 1, worldwide: 1, formats: 1 } },
    ],
  },
  {
    id: 'mood',
    ...
    options: [
      ...
      { label: 'Philosophical: the harder questions', weights: { ethics: 3, 'letting-go': 2 } },
